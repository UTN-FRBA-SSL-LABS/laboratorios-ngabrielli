...
> R:Inicia el carrito poneiendo todo en 0.
...
> R:24, que estaba solamente el precio del producto en una sola unidad. 

**P7** — ¿Qué debería hacer esa línea para calcular el total correctamente?

> R:Multiplicar el precio de cada producto por su cantidad.
...
> R:El test falla, el quinto carrito_agregar devuelve 1.
...
> R:El operador que se usaba era incorrecto. Tiene que ser < para que solo agregue mientras sea mernos que MAX_ITEMS.
...
> R:Si, hay 3 lineas la 14, la 29 y 30.
...
> R:Que uno prueba una funcion de forma aislada y el otro prueba varias funcionaes juntas. Y el bug, lo entontró primero el test unitario. 
...
> R:Por que podes escribir por afuera del array y pisar memoria. 
...
> R:Para que no se te escapen cosas que no estan a simple vista y te chequean que lo esperado sea igual a lo que calculamos.
...
> R:Por que en el unitario, las cantidades no importaban al ser solo una unidad. mientras que con cantidad ya nos daba mal.
